...
primal_results, expenditure = RunnerModel1(path).run_model()
print("Primal Results:\n", primal_results)
print("Total Expenditure:", expenditure)
plot_primal_results(primal_results, save_path=Path(path)/"figures"/"Model_1_primal_results", show=True, show_price_line=True, line_label="Price (DKK/Btu)",
title=f"Primal Results for Model 1, Daily Expenditure = {expenditure:.2f} DKK")